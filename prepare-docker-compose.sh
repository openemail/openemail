...
sed -i 's#image: mailcow/redis:.*#image: hub.cybergate.lk/openemail/redis:OPENEMAIL_VERSION#' docker-compose.yml
...
sed -i 's#image: mailcow/memcached:.*#image: hub.cybergate.lk/openemail/memcached:OPENEMAIL_VERSION#' docker-compose.yml
sed -i 's#image: mailcow/nginx:.*#image: hub.cybergate.lk/openemail/nginx:OPENEMAIL_VERSION#' docker-compose.yml
